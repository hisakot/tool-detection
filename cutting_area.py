...
if __name__ == '__main__':
    ...
    # open via json file
    tmp = open('../cutting_area_data/via_annotation_breast_surgery.json', 'r')
    ...
    if not args.evaluation:
        ...
        for idx in tqdm(range(len(img_paths))):
            ...
            cv.imwrite('../main20170707/cutting_area/'+img_paths[idx].split(os.sep)[-1], img)
